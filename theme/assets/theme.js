  ...
  var Accessibility = function () {
    ...
    _createClass(Accessibility, null, [{
      ...
      value: function removeTrapFocus(container, namespace) {
        ...
        if (this.listeners !== undefined && this.listeners[namespace] !== undefined) {
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Popover = function () {
    function Popover(element, options) {
      ...
      this.activators = document.querySelectorAll('[aria-controls="' + element.getAttribute('id') + '"]');
    ...
    _createClass(Popover, [{
      ...
      value: function _attachListeners() {
        ...
        var toggleListener = this._toggleListener;
        this.activators.forEach(function(el){el.addEventListener('click',toggleListener);});
...
if (window.BOLD && BOLD.common && BOLD.common.eventEmitter && typeof BOLD.common.eventEmitter.emit === 'function'){
  BOLD.common.eventEmitter.emit('BOLD_COMMON_variant_changed',{variant:newVariant});
}
}
      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (!newVariant) {
          ...
          if (newVariant['compare_at_price'] > newVariant['price']) {
            productMetaPrices.innerHTML += '<span class="ProductMeta__Price Price Price--highlight Text--subdued h4" data-money-convertible>' + __WEBPACK_IMPORTED_MODULE_4__helper_Currency__["default"].formatMoney(newVariant['price'], window.theme.moneyFormat) + '</span>';
            productMetaPrices.innerHTML += '<span class="ProductMeta__Price Price Price--compareAt Text--subdued h4" data-money-convertible>' + __WEBPACK_IMPORTED_MODULE_4__helper_Currency__["default"].formatMoney(newVariant['compare_at_price'], window.theme.moneyFormat) + '</span>';
          } else {
            productMetaPrices.innerHTML += '<span class="ProductMeta__Price Price Text--subdued h4" data-money-convertible>' + __WEBPACK_IMPORTED_MODULE_4__helper_Currency__["default"].formatMoney(newVariant['price'], window.theme.moneyFormat) + '</span>';
          }
          ...
          if (_this32.options['drawer'] && elementToAnimate) {
            var timelineLite = new TimelineLite({ onComplete: function onComplete() {
                content.text().then(function (html) {
                  ...
                  document.dispatchEvent(new CustomEvent('cart:reloaded'));
                });
              } });
...
if (window.BOLD && BOLD.common && BOLD.common.eventEmitter && typeof BOLD.common.eventEmitter.emit === 'function'){ BOLD.common.eventEmitter.emit('BOLD_COMMON_cart_loaded');}
  ...
  var CollectionSection = function () {
    function CollectionSection(element) {
      ...
      if (this.settings['filterPosition'] === 'sidebar') {
        ...
        this.filterInnerSidebarScroller = new __WEBPACK_IMPORTED_MODULE_5__components_OverflowScroller__["default"](this.element.querySelector('#gf-tree'));
      }
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  /* harmony import */var __WEBPACK_IMPORTED_MODULE_57__FeaturedProductListSection__ = __webpack_require__(57);
  /* harmony reexport (binding) */__webpack_require__.d(__webpack_exports__, "FeaturedProductListSection", function () {
    return __WEBPACK_IMPORTED_MODULE_57__FeaturedProductListSection__["default"];
  });
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  (function () {
    ...
    sections.register('featured-product-list', __WEBPACK_IMPORTED_MODULE_2__sections__["FeaturedProductListSection"]);
...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  var FeaturedProductListSection = function () {
    function FeaturedProductListSection(container) {
      _classCallCheck(this, FeaturedProductListSection);

      this.element = container;

      var featuredProductListElement = this.element.querySelector('[data-flickity-config]');

      if (featuredProductListElement) {
        this.carousel = new __WEBPACK_IMPORTED_MODULE_0__components_Carousel__["default"](featuredProductListElement);
      }
    }

    _createClass(FeaturedProductListSection, [{
      key: 'onUnload',
      value: function onUnload() {
        if (this.carousel) {
          this.carousel.destroy();
    ...
    return FeaturedProductListSection;
  }();
  /* harmony export (immutable) */

  __webpack_exports__["default"] = FeaturedProductListSection;
